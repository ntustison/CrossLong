...
## _Cortical residual and between-subject thickness variability_ {-}
...
The LME model defined in Equation (1) was used to quantify the between-subject
...
Figure 3 provides the resulting 95\% credible intervals
...
The plot in
Figure 4 shows a relative summary of all the regional quantities
...
corresponding regions of a 3-D rendering of the ADNI template (Figure 5)
to provide an additional visual comparison between the methods.

## _Regional diagnostic contrasts based on cortical atrophy_ {-}
...
95\% confidence intervals.  Figure 6 provides a side-by-side comparison of the
