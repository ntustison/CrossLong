...
research. Furthermore, future studies, e.g., cross validation
...
\textcolor{blue}{Finally, it should be noted that while the current findings
certainly have utility, they are limited to a specific population and
the community would benefit from replication and exploration in other populations.}
