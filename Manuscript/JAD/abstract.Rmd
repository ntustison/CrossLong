...
we evaluate the utility of longitudinal FreeSurfer and
\textcolor{blue}{Advanced Normalization Tools (ANTs)} surrogate thickness values
in the context of a \textcolor{blue}{linear} mixed-effects (LME) modeling strategy.
