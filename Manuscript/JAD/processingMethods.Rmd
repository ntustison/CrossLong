...
from a 20-cohort subset of both the OASIS[^2] and MMRR [@landman2011] data sets
...
images taken from four publicly available data sets (i.e., IXI[^3], MMRR,
NKI [@Nooner:2012aa], and OASIS) were used to predict age and gender using linear and
...
volumes, and Jacobian determinant values) were made available online.[^4]  These include the
...
[^4]: https://github.com/ntustison/KapowskiChronicles
...
with the actual implementation provided in the class <tt>itk::DiReCTImageFilter</tt> available as
