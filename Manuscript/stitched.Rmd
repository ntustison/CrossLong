...
Given the above description, there are three major processing choices for
...
\caption{Density plot of the accuracy for each of the three pipeline choices along with 
the distribution produced from random guessing.  Accuracy was
