...
FreeSurfer, 
longitudinal mixed-effects, longitudinal processing
...
\textcolor{blue}{An ANTs implementation of the denoising algorithm of} [@Manjon:2010aa] 
\textcolor{blue}{is a recent addition to the toolkit and has been added as an option 
...
\textcolor{blue}{to account for the spatial varying noise in MR images in addition
to consideration of the inherent Rician noise in MRI.  This preprocessing step has been used
in a variety of imaging studies for enhancing segmentation-based protocols including}
\textcolor{blue}{hippocampal and ventricle segmentation} [@Coupe:2011aa],
\textcolor{blue}{voxel-based morphometry in cannabis users} [@Cousijn:2012aa],
\textcolor{blue}{and anterior temporal lobe gray matter volume in bilingual adults} [@Abutalebi:2014aa].
\textcolor{blue}{An illustration of the transformed data resulting from image 
...
intensities whereas the latter reduces the high frequency spatially-varying Rician noise.} }
\label{fig:denoising}
\end{figure}
...
(e.g., Alzheimer's disease). As such this
...
Irvine.  Based on the evaluation design described in the previous section, 
...
varying cortical atrophy rates in the ADNI population [@Leung:2013aa].  
...
Longitudinal-native method dominates the others across the majority of
...
protocols.  It inherits the performance capabilities of the ANTs cross-sectional 
