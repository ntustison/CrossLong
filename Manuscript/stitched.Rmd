...
of processing bias by transforming the images to a position halfway between the two.
...
data processing [@Fox:2011aa;@Reuter:2012aa;@Hua:2013aa].

In a series of papers [@Reuter:2010aa;@Reuter:2011aa;@Reuter:2012aa] the authors
motivated the design and implementation of the longitudinal FreeSurfer stream partly
...
[@Bernal-Rusiel:2013aa] and used in a variety of studies including pediatric
...
_Longitudinal ADNI imaging data_
...
_ANTs Cross-sectional processing_
...
trends.  As such, these models are useful for the analysis of longitudinaly
