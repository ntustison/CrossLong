...
{\tt multcomp} package in R to test 
...
do not manifest similar trends in ANTs Cross (e.g., LMCI-CN:  lateral occipital gyri).  Pronounced
...
tensor-based morphometry} [@Vemuri:2015aa]\textcolor{blue}{.  Local folding 
and other curvature-based metrics are available, as well, through ANTsR} 
[@Muschelli:2018aa]\textcolor{blue}{.  These quantification tools, individually or jointly, 
