...
be seen in the distribution of prediction errors, the two ANTs longitudinal
piplines (ANTs SST and ANTs Native) consistently have higher prediction 
accuracy (i.e., lower prediction error).}  

\begin{figure}[ht!]
\centering
\includegraphics[width=\textwidth]{../Data/RegionalAgePredictionPlots/accuracyTotal.png}
\caption{\textcolor{blue}{Age prediction error in years for each of the five processing pipelines
over the 62 cortical regions.  Consistent with the variance ratio comparison, we see that ANTs
SST and ANTs Native trend towards a lower relative prediction error. }
}
