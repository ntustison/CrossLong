...
\textcolor{blue}{An ANTs implementation of the denoising algorithm described in} [@Manjon:2010aa] 
...
to specific consideration of the Rician noise inherent to MRI} [@Gudbjartsson:1995aa]\textcolor{blue}{.
...
\textcolor{blue}{Pipeline-specific LME models were constructed for each DKT region
relating the change in cortical thickness to diagnosis and other pertinent covariates.  
In the notation of} [@wilkinson1973]\textcolor{blue}{, these regional LME models are defined
as:}
...
\caption{\textcolor{blue}{Log-scaled $p$-values summarizing Tables 2 and 3 demonstrating performance differences
...
\textcolor{blue}{
Consideration of performance over all three diagnostic categories illustrates the superiority 
of the longitudinal ANTs methodologies over their ANTs cross-sectional counterpart.  Several
regions demonstrating statistically significant non-zero atrophy in ANTsNative and ANTsSST 
do not manifest similar trends in ANTsCross (e.g., LMCI-CN:  lateral occipital gyri)
}
...
protocols.  \textcolor{blue}{This framework has been publicly available as open-source
