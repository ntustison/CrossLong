...
\input{leftAovTable.tex}

\input{rightAovTable.tex}
...
regional values are further grouped by diagnosis (i.e., CN vs. LMCI vs.
...
including those specifically related to} "\textcolor{blue}{ground zero}" 
\textcolor{blue}{in  Alzheimer's disease, e.g.,
the entorhinal regions} 
