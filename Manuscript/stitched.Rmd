...
correlates, especially neurodegenerative conditions such as Alzheimer’s
...
estimation (right column, red panel) which we refer to as ``Longitudinal-SST''.  For regional
...
As described above, given a set of longitudinal data, there are three possible options
...
In this section we describe the statistical framework for evaluating each possibility.
...
Therefore, Figure \ref{fig:ratios} may be considered as evidence for method Longitudinal-native
