...
ANTs-based lower predictive error is consistent with corresponding variance ratios.
}
...
\caption{\textcolor{blue}{$\Delta$MMSE prediction error for each of the longitudinal processing pipelines
