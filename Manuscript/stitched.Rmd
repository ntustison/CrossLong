...
A complementary training/prediction evaluation provides additional evidence of the
...
estimation (right column, red panel) which we refer to "Longitudinal 1".  For regional
thickness values, regional labels
can be propagated to each image using a given atlas set and cortical parcellation
scheme.](../Figures/longitudinalPipeline.png)
