...
The LACT pipeline provides unbiased structural neuroimage processing and competitive 
...
pipeline, we use those slope values to predict age and MMSE scores (cf Figure 
...
population and the prominent role of the entorhinal region for AD pathology indication}
[@Yassa:2014aa] \textcolor{blue}{is used to show that
the higher variance ratio of FSLong translates to superior
MMSE prediction performance. Thus, we evaluate the variance ratio in the context 
of the linear model 
\begin{equation}
...
\begin{figure}[ht!]
\centering
\includegraphics[width=0.5\textwidth]{../Data/RegionalPredictionPlots/accuracyEcTotal.png}
