...
and 123 AD subjects.  Further breakdown of demographic information is given
...
2. Application of the ANTs cross-sectional pipeline to the SST.
3. Creation of the SST prior probability maps.
4. (Optional):  Rigid transformation of each individual time point to the SST.
5. Application of the ANTs cross-sectional pipeline to each individual time-point image.
