...
modeling strategy.  \textcolor{blue}{It is known from the statistical literature that} 
...
the cross-sectional and longitudinal FreeSurfer processing streams.  \textcolor{blue}{
The longitudinal ANTs framework provides unbiased structural neuroimage processing and competitive 
to superior power for longitudinal structural change detection.}

_Keywords:_  Advanced Normalization Tools,
\textcolor{black}{FreeSurfer}, 
...
longitudinal tensor-based morphometry, Eigenanatomy} [@Kandel:2015aa]\textcolor{blue}{, and extension to non-human data.}
...
registration algorithm} [@Avants:2011ab;@Avants:2014aa] \textcolor{blue}{which forms the core of the ANTs toolkit 
...
3. Application of the ANTs cross-sectional \textcolor{blue}{cortical thickness} pipeline [@Tustison:2014ab] 
   to the SST \textcolor{blue}{with the group template and priors as input.}
...
Herein we detailed the ANTs \textcolor{blue}{registration-based} longitudinal cortical 
thickness framework which is designed to take advantage of longitudinal data acquisition 
protocols.  \textcolor{blue}{It inherits the performance capabilities of the ANTs cross-sectional 
...
[@Klein:2009aa;@Tustison:2015aa]\textcolor{blue}{) and provides accurate correspondence
...
\textcolor{blue}{are non-existent which enhances inclusion of other imaging data and
...
\textcolor{blue}{
All processing streams exhibited demonstrated feasibility of longitudinal cortical thickness
...
[@Lehmann:2012aa] \textcolor{blue}{and surface curvature} [@Avants:2003aa]\textcolor{blue}{) provide a convenient 
