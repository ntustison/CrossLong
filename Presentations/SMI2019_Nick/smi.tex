...
\begin{itemize}
\item
  is all the extra longitudinal processing worth it? I.e., is it better
  than just processing everything through the cross-sectional pipeline?
\item
...
\begin{itemize}
\item
  can we determine if the cortical thickness measures are somehow better
  than FreeSurfer's?
\item
